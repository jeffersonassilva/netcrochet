...
const ImagensProduto = ({ images }) => {
  ...
  return (
    <div className="mb-4 md:grid md:grid-cols-[1fr_100px] md:gap-3 lg:grid-cols-1 lg:row-start-1 lg:row-span-5 lg:flex lg:flex-col">
      <div
        className="flex-1 flex items-center justify-center mb-4 p-2
      bg-white border-2 border-[#f9ecd8] rounded-sm lg:mb-0"
      >
        <img
      ...
      <div className="grid grid-cols-5 gap-2 mb-4 md:grid-cols-[120px] lg:grid-cols-5 lg:flex-1 lg:items-start md:mb-0">
