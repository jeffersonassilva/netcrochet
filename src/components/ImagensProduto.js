...
const ImagensProduto = ({ images }) => {
  ...
  return (
    <div
      className="mb-4 md:grid md:grid-cols-[1fr_120px] md:gap-3
    lg:grid-cols-1 lg:row-start-1 lg:row-span-5 lg:flex lg:flex-col"
    >
      <div
      ...
      <div
        ...
        md:mb-0 md:grid-cols-[120px] md:grid-rows-5
        lg:grid-rows-1 lg:grid-cols-5 lg:flex-1 lg:items-start"
      >
